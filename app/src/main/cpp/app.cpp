...
static GLOBJECT *sSuperShapeObjects[SUPERSHAPE_COUNT] = { nullptr };
static GLOBJECT *sGroundPlane = nullptr;
...
void appInit() {
    ...
    for (a = 0; a < SUPERSHAPE_COUNT; ++a) {
        ...
        assert(sSuperShapeObjects[a] != nullptr);
    }

    sGroundPlane = createGroundPlane();
    assert(sGroundPlane != nullptr);
}
